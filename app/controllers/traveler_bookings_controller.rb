class TravelerBookingsController < ApplicationController
  ...
  def new
    ...
    @booking = Booking.new
    @booking.assign_attributes(guide_id: @guide.id, traveler_id: @traveler.id,
                traveler_first_name: @member.first_name, traveler_last_name: @member.last_name,
                traveler_email: @member.email, traveler_telphone: @member.telphone)
  ...
  private
  def booking_params
    attrs = [:traveler_id, :guide_id, :traveler_first_name, :traveler_last_name, :traveler_email, :traveler_telphone, :traveler_country]
